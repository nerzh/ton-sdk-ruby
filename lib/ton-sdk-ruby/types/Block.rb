  ...
  class OutAction
    ...
    def self.parse(cs)
      ...
      when 0x0ec3c86d # action_send_msg
        ...
        data = { tag: 'action_send_msg', mode: mode, out_msg: Message.parse(out_msg) }
      when 0xad4de08e # action_set_code
        data = { tag: 'action_set_code', new_code: cs.load_ref }
      else
        raise 'OutAction: unexpected tag'
      end
